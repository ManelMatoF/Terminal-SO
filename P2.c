...
void insert_Comands(){
    ...
    for (int i = 0; i < MAX_COMANDS; i++){
        switch (i) {
            ...
            case 30:
                strcpy(c->comand, "uid");
                strcpy(c->help_comand, "uid [-get|-set] [-l] [id]\tAccede a las credenciales del proceso que ejecuta el shell"
            ...
            case 31:
                ...
                break;
            case 32:
                strcpy(c->comand, "changevar");
                strcpy(c->help_comand, "changevar [-a|-e|-p] var valor\tCambia el valor de una variable de entorno\n"
